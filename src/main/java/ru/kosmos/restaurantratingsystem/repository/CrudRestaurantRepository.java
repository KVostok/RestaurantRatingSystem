...
//    https://coderoad.ru/9710252/%D0%9A%D0%B0%D0%BA-%D1%81%D0%B4%D0%B5%D0%BB%D0%B0%D1%82%D1%8C-%D1%81%D0%BB%D0%BE%D0%B6%D0%BD%D0%BE%D0%B5-%D1%83%D1%81%D0%BB%D0%BE%D0%B2%D0%B8%D0%B5-LEFT-JOIN-%D0%B2-JPQL
    @EntityGraph(attributePaths = {"menues"}, type = EntityGraph.EntityGraphType.LOAD)
    @Query("select r from Restaurant r left join r.menues as m on m.date = ?1 or m.date is null order by r.name")
    List<Restaurant> getAllRest(LocalDate today);
