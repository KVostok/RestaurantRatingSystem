...
VALUES ('Admin', 'admin@gmail.com', 'admin'),
       ...
       ('User8', 'user8@yandex.ru', 'password'),
       ('User9', 'user9@yandex.ru', 'password'),
       ('User10', 'user10@yandex.ru', 'password'),
       ('User11', 'user11@yandex.ru', 'password'),
       ('User12', 'user12@yandex.ru', 'password'),
       ('User13', 'user13@yandex.ru', 'password'),
       ('User14', 'user14@yandex.ru', 'password'),
       ('User15', 'user15@yandex.ru', 'password'),
       ('User16', 'user16@yandex.ru', 'password'),
       ('User17', 'user17@yandex.ru', 'password'),
       ('User18', 'user18@yandex.ru', 'password'),
       ('User19', 'user19@yandex.ru', 'password'),
       ('User20', 'user20@yandex.ru', 'password');
...
VALUES  (TODAY, 10000),
        ...
        (DATE_SUB(TODAY, INTERVAL 1 DAY), 10000),
        (DATE_SUB(TODAY, INTERVAL 1 DAY), 10001),
        (DATE_SUB(TODAY, INTERVAL 1 DAY), 10002),
        (DATE_SUB(TODAY, INTERVAL 1 DAY), 10003),
        (DATE_SUB(TODAY, INTERVAL 1 DAY), 10004),
        (DATE_SUB(TODAY, INTERVAL 1 DAY), 10005),

        (DATE_SUB(TODAY, INTERVAL 2 DAY), 10000),
        (DATE_SUB(TODAY, INTERVAL 2 DAY), 10001),
        (DATE_SUB(TODAY, INTERVAL 2 DAY), 10002),
        (DATE_SUB(TODAY, INTERVAL 2 DAY), 10003),
        (DATE_SUB(TODAY, INTERVAL 2 DAY), 10004),
        (DATE_SUB(TODAY, INTERVAL 2 DAY), 10005);
